...
const FEATURES = [
  ...
  { icon: "🤖", title: "AI Recipe Generation", desc: "Tell us what you have. We'll create a recipe perfectly matched to your pantry." },
  { icon: "📅", title: "Weekly Meal Planner", desc: "Plan your whole week in seconds. Auto-generates your shopping list for everything you're missing." },
  { icon: "🎤", title: "Voice Navigation", desc: "Fully accessible voice control. Built for blind users from the ground up — a world first." },
  { icon: "☁️", title: "Cloud Sync", desc: "Your recipes, pantry and shopping list sync across every device. Always with you." },
  { icon: "🔗", title: "Import Any Recipe", desc: "Found a recipe online? Paste the URL and it's saved instantly — scaled to your serving size." },
];
    ...
    <div style={{ background: "#0a0a0a", color: "#f5f0e8", minHeight: "100vh", fontFamily: "'Georgia', 'Times New Roman', serif", overflowX: "hidden" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        .hero-title {
          ...
          font-weight: 900; line-height: 0.92; letter-spacing: -2px; color: #f5f0e8;
        }
        ...
        .nav-fixed {
          ...
          border-bottom: 1px solid rgba(196,98,45,0.15); transition: border-color 0.3s;
        }
        .nav-scrolled { border-bottom-color: rgba(196,98,45,0.4); }
        .cta-btn {
          background: #c4622d; color: #fff; border: none; padding: 14px 32px;
        ...
        .feature-card::before {
          ...
          background: linear-gradient(90deg, transparent, #c4622d, transparent); opacity: 0; transition: opacity 0.3s;
        }
        ...
        .big-quote {
          font-family: 'Playfair Display', serif; font-size: clamp(24px, 5vw, 48px);
          font-weight: 400; font-style: italic; line-height: 1.3; color: rgba(245,240,232,0.7);
        }
        .big-quote strong { color: #f5f0e8; font-style: normal; font-weight: 900; }
        .countdown-box {
          display: inline-flex; gap: 0; background: rgba(196,98,45,0.08);
          border: 1px solid rgba(196,98,45,0.3); padding: 16px 24px;
        ...
        .countdown-num {
          ...
          color: #c4622d; display: block; line-height: 1;
        }
        .countdown-label {
          font-family: 'DM Sans', system-ui, sans-serif; font-size: 10px;
          text-transform: uppercase; letter-spacing: 2px; color: rgba(245,240,232,0.4);
          display: block; margin-top: 4px;
        }
        .legal-link {
          color: rgba(245,240,232,0.35); font-family: 'DM Sans', system-ui, sans-serif;
          font-size: 12px; cursor: pointer; text-decoration: underline; background: none; border: none;
          transition: color 0.2s;
        }
        .legal-link:hover { color: #c4622d; }
      ...
      <section className="hero-section" style={{ padding: "180px 24px 100px", maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <h1 className={`hero-title hero-fade-in delay-1 ${visible ? "visible" : ""}`}>
          Your fridge.<br /><em>Your recipes.</em><br />Your way.
        </h1>
      ...
      <section style={{ padding: "100px 24px", maxWidth: 1000, margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div style={{ marginBottom: 60 }}>
          ...
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(32px, 6vw, 56px)", fontWeight: 900, lineHeight: 1.1, color: "#f5f0e8" }}>
            Built for real kitchens.<br /><em style={{ color: "#c4622d", fontStyle: "italic" }}>Not recipe blogs.</em>
          </h2>
        </div>
      ...
      <section style={{ padding: "80px 24px", maxWidth: 800, margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div style={{ border: "1px solid rgba(196,98,45,0.3)", padding: "48px", background: "rgba(196,98,45,0.04)", position: "relative", overflow: "hidden" }}>
          ...
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(24px, 4vw, 40px)", fontWeight: 900, color: "#f5f0e8", marginBottom: 16, lineHeight: 1.2 }}>
            Built for <em style={{ color: "#c4622d", fontStyle: "italic" }}>everyone.</em><br />Including blind users.
          </h2>
          <p className="body-font" style={{ fontSize: 16, color: "rgba(245,240,232,0.6)", lineHeight: 1.8, marginBottom: 24 }}>
            Full voice navigation, screen reader support, and fridge scanning for visually impaired users. Che AF is the first recipe app built with blind users as a core audience — not an afterthought.
          </p>
      ...
      {/* Footer */}
      <footer style={{ borderTop: "1px solid rgba(245,240,232,0.06)", padding: "40px 24px", textAlign: "center", position: "relative", zIndex: 1 }}>
